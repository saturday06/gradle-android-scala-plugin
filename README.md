...
| ------ | ------ | ------------------- | ----------------- | ----------------- |
| 2.11.8 | 2.10   | 2.1.2               | 21, 22, 23, 24    | 23.0.3            |
| 2.10.6 | 2.10   | 2.1.2               | 21, 22, 23, 24    | 23.0.3            |

If you want to use older build environments please try older version of the plugin.
