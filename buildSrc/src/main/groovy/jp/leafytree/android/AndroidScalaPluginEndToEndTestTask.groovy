...
public class AndroidScalaPluginEndToEndTestTask extends DefaultTask {
    ...
    def run() {
        ...
        [
            ...
            def (gradleVersion, scalaLibraryVersion, androidPluginVersion, androidPluginCompileSdkVersion,
                 androidPluginBuildToolsVersion, androidPluginMinSdkVersion, androidPluginTargetSdkVersion) = it
...
""")
                ...
                def command = []
                if (org.apache.tools.ant.taskdefs.condition.Os.isFamily(Os.FAMILY_WINDOWS)) {
