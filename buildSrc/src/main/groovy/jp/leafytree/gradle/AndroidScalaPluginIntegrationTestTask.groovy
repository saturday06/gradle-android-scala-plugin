...
public class AndroidScalaPluginIntegrationTestTask extends DefaultTask {
    ...
    def run() {
        ...
        [
            ...
            [
                    ["2.2.1", true,  "2.11.5", "1.0.1", "android-21", "21.1.2", "8", "21"],
                    ["2.2.1", false, "2.10.4", "1.0.1", "android-21", "21.1.2", "8", "21"],
                    ["1.12", false, "2.11.5", "0.12.2", "android-21", "21.1.2", "8", "21"],
                    ["1.12", false, "2.10.4", "0.12.2", "android-21", "21.1.2", "8", "21"],
                    ["1.12", false, "2.11.5", "0.12.2", "android-19", "19.1.0", "8", "19"],
    ...
    def getGradleProperties(scalaLibraryVersion, androidPluginVersion, androidPluginCompileSdkVersion,
        ...
        gradleProperties.putAll([
                ...
                androidScalaPluginVersion: "1.3.3-SNAPSHOT",
